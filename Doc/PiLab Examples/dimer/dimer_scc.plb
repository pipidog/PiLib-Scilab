...
scc.Charge=[0.5,0.5,0.5,0.5]                     // charge of each state, 1x total state
...
scc.Mesh=[200]                       // k-space mesh for Ef, (1x1,1x2,1x3), large for metal
...
ORDER=    0, SIZE=[    5,    3], TYPE=SPARSE
       ...
       3       3    0.500000  0.000000
       4       4    0.500000  0.000000
